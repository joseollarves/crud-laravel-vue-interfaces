                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group" >
                                                ...
                                                <div class="input-group-append">
                                                    <router-link to="/tipos" class="btn btn-primary">Registro de
                                                        Tipos</router-link>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <div class="container">
                                                ...
                                                <div class="row">
                                                    <div class="column">
                                                        <img :src="getFotoPrimera()" class="demo cursor" style="width:100%"
                                                            onclick="currentSlide(1)" alt="The Woods">
                                                    </div>
                                                    <div class="column">
                                                        <img :src="getFotoSegunda()" class="demo cursor" style="width:100%"
                                                            onclick="currentSlide(2)" alt="Cinque Terre">
                                                    </div>
                                                    <div class="column">
                                                        <img :src="getFotoTercera()" class="demo cursor" style="width:100%"
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input @change="actualizarFotoPrimera" type="file" class="custom-file-input" id="exampleInputFile">
